...
const UpdateNotesValidateionSchema = yup.object().shape({
  title: yup
    .string()
    .required("Title is required")
    .min(10, "Title must be 10 characters log")
...
export const UpdateNotesModal = ({ onClose, todo, onSubmit }: IProps) => {
  return (
    <Modal size="sm" onClose={onClose}>
      ...
      <Formik
        ...
        validationSchema={UpdateNotesValidateionSchema}
      >
        <Form>
          <Separator />
          <FieldRowItem>
